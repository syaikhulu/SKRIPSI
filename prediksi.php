            ...
            <form method="post" action="" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <label class="radio-inline">
                            <input type="radio" class="square-black" value="cerai"  name="status_pernikahan" 
                                   <?php echo isset($_POST['status_pernikahan'])?($_POST['status_pernikahan']=='cerai'?"checked":""):""; ?> required="">
                            cerai
                        </label>
                    </div>
                </div>
